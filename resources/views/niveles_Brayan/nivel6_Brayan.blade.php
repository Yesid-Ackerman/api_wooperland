...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/niveles_Brayan/nivel6_Brayan.css') }}">
...
<body>
    <div class="container">
        ...
        <div class="wooper1">
            <img src="{{ asset('imgs/niveles/wooper6.png') }}" alt="wooper de astronomia">
        </div>
        <div class="level1">
            <h1>1</h1>
        </div>
        ...
        <div class="descripcion">
            <img class="desAstronomia" src="{{ asset('imgs/niveles/astronomia.png') }}" alt="anuncio">
            <div class="cerrar"> <a href="{{route('nivel6-1')}}">
