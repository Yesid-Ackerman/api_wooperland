...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/niveles_Brayan/nivel2_Brayan.css') }}">
...
<body>
    <div class="container">
        ...
        <div class="wooper1">
            <img src="{{ asset('imgs/niveles/wooper.2.png') }}" alt="wooper de elnguaje">
        </div>
        <div class="level1">
            <h1>1</h1>
        </div>
        ...
        <div class="descripcion">
            <img class="desMatematicas" src="{{ asset('imgs/niveles/naturales.png') }}" alt="anuncio">
            <div class="cerrar"> <a href="{{route('nivel2-1')}}">
