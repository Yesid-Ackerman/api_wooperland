...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/niveles_Brayan/nivel7_Brayan.css') }}">
...
<body>
    <div class="container">
        ...
        <div class="wooper1">
            <img src="{{ asset('imgs/niveles/wooper7.png') }}" alt="wooper de geografia">
        </div>
        <div class="level1">
            <h1>1</h1>
        </div>
        ...
        <div class="descripcion">
            <img class="desGeografia" src="{{ asset('imgs/niveles/geografia.png') }}" alt="anuncio">
            <div class="cerrar"> <a href="{{route('nivel7-1')}}">
