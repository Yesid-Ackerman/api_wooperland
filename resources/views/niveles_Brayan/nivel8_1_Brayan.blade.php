...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/niveles_Brayan/nivel8.1_Brayan.css') }}">
    <link href="https://fonts.googleapis.com/css2?family=Pajji&display=swap" rel="stylesheet">
</head>

<body>
    <div class="container">
        <div class="flecha"><a href="{{ route('nivel8') }}">
                <img src="{{ asset('imgs/niveles/flecha.izquierda.PNG') }}" alt="flrcha inicio">
            </a>
        </div>
