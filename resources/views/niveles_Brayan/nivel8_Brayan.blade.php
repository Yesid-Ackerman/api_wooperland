...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/niveles_Brayan/nivel8_Brayan.css') }}">
...
<body>
    <div class="container">
        ...
        <div class="wooper1">
            <img src="{{ asset('imgs/niveles/wooper8.png') }}" alt="wooper de desProgramacion">
        </div>
        <div class="level1">
            <h1>1</h1>
        </div>
        ...
        <div class="descripcion">
            <img class="desProgramacion" src="{{ asset('imgs/niveles/programacion.png') }}" alt="anuncio">
            <div class="cerrar"> <a href="{{route('nivel8-1')}}">
