...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/niveles_Brayan/nivel5_Brayan.css') }}">
...
<body>
    <div class="container">
        ...
        <div class="wooper1">
            <img src="{{ asset('imgs/niveles/wooper5.png') }}" alt="wooper de historia">
        </div>
        <div class="level1">
            <h1>1</h1>
        </div>
        ...
        <div class="descripcion">
            <img class="desHistoria" src="{{ asset('imgs/niveles/historia.png') }}" alt="anuncio">
            <div class="cerrar"> <a href="{{route('nivel5-1')}}">
