...
<body class="flex flex-col" style="font-family: 'Happy Monkey', sans-serif">
    ...
    <main class="min-h-[80vh] bg-[url('/public/img/image1.png')] bg-cover flex bg-center items-center justify-around px-8"> {{-- Si bajamos a 80vh podemos descomentar el footer, solo si se baja a 80 el minimo de H --}}
        <div class="h-64 w-64">
        </div>        
