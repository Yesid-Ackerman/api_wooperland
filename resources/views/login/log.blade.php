...
@section('content')
    <div class="stepper mt-8 mb-2 flex justify-between items-center transform scale-110">
        ...
        <a href="{{ route('pass') }}"><div class="step active bg-[#EF476F] text-white text-3xl rounded-full w-16 h-16 flex justify-center items-center border-2 border-white">2</div></a>
        <div class="connector bg-[#EF476F] h-4 w-48 border-y-2 border-white"></div>
        <a href="{{ route('terminos') }}"><div class="step active bg-[#EF476F] text-white text-3xl rounded-full w-16 h-16 flex justify-center items-center border-2 border-white">3</div></a>
    </div>
