        ...
        <div class="custom-bg flex justify-center items-center w-1/2">
            ...
            <div class="flex flex-col justify-center items-center w-full flex-grow mt-0.5">  
                ...
                <div class="grid grid-cols-1 gap-6 justify-items-center w-full  mt-0">
                    <button class="bg-gray-300 hover:bg-blue-600 text-gray-700 text-3xl font-bold py-6 rounded-3xl focus:outline-none truncate focus:shadow-outline w-2/3 h-40 flex items-center justify-center border-4 border-black">
                    ...
                    <button class="bg-gray-300 hover:bg-green-600 text-gray-700 text-3xl font-bold py-6 rounded-3xl focus:outline-none truncate focus:shadow-outline w-2/3 h-40 flex items-center justify-center border-4 border-black">
                    ...
                    <button class="bg-gray-300 hover:bg-yellow-600 text-gray-700 text-3xl font-bold py-6 rounded-3xl focus:outline-none truncate focus:shadow-outline w-2/3 h-40 flex items-center justify-center border-4 border-black">
                    ...
                    <button class="bg-gray-300 hover:bg-red-600 text-gray-700 text-3xl font-bold py-6 rounded-3xl focus:outline-none truncate focus:shadow-outline w-2/3 h-40 flex items-center justify-center border-4 border-black">
