...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style_Temas_Haiver/style-geografia_Haiver.css') }}">
</head>
...
<body>
    ...
    <div class="descripcion_geografia">
        <div class="imfo_geografia">
            <h2> &#x1F5FA; Geografía</h2>
            <p>Un festival multicultural donde los niños pueden explorar diferentes países, idiomas y tradiciones a
                través de juegos, música y manualidades. Una experiencia divertida y educativa que celebra la diversidad
                del mundo.</p>
            <img src="{{ asset('/imgs/Temas_imgs_Haiver/img-geografia.png') }}" alt="Geografía">
        </div>
    </div>
