...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style_Temas_Haiver/style-matematicas_Haiver.css') }}">
</head>
...
<body>
    ...
    <div class="descripcion_matematicas">
        <div class="imfo_matematicas">
            <h2> &#x1F522; Matemáticas</h2>
            <p>Un jardín encantado lleno de flores numéricas y criaturas amigables. Los niños pueden aprender conceptos
                básicos de números y formas mientras exploran el colorido jardín.</p>
            <img src="{{ asset('/imgs/Temas_imgs_Haiver/img-matematicas.png') }}" alt="Matemáticas">
        </div>
    </div>
