...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style_Temas_Haiver/style-tecnologia_Haiver.css') }}">
</head>
...
<body>
    ...
    <div class="descripcion_tecnologia">
        <div class="imfo_tecnologia">
            <h2> &#x1F4F1; Tecnología </h2>
            <p>Una metrópolis tecnológica donde los niños pueden explorar inventos futuristas y experimentar con
                dispositivos electrónicos y gadgets. A través de actividades interactivas, los niños aprenden sobre
                tecnología, innovación y cómo la ciencia y la ingeniería pueden mejorar nuestras vidas.</p>
            <img src="{{ asset('/imgs/Temas_imgs_Haiver/img-tecnologia.png') }}" alt="Tecnología">
        </div>
    </div>
