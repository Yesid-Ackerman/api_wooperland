...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style_Temas_Haiver/style-programacion_Haiver.css') }}">
</head>
...
<body>
    ...
    <div class="descripcion_programacion">
        <div class="imfo_programacion">
            <h2> &#x1F4BB; Programación </h2>
            <p>Una ciudad futurista donde los edificios están hechos de código y los robots son los habitantes. Los
                niños pueden aprender conceptos básicos de programación y lógica de manera lúdica y visual,
                interactuando con robots y resolviendo desafíos de codificación.</p>
            <img src="{{ asset('/imgs/Temas_imgs_Haiver/img-programacion.png') }}" alt="Programación">
        </div>
    </div>
