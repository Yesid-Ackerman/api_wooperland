...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/style_Foto_Perfil_Haiver/style_CIMG_Vista_2_Haiver.css') }}">
...
<body>
    ...
    <div class="container_imagen">
        ...
        <div class="conseguir-imagen">
            ...
            <div class="img"> <img src="{{ asset('/imgs/Foto_Perfil_imgs_Haiver/3-img-conseguir.png') }}"> </div>
    ...
    <div class="sin-conseguir">
        <img class="img-bloqueada-1" src="{{ asset('/imgs/Foto_Perfil_imgs_Haiver/1-img-bloqueada.png') }}">
    </div>
